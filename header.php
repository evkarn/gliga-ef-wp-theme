 ...
 */
	...
	$title = carbon_get_the_post_meta('crb_page_meta_title');
	$descr = carbon_get_the_post_meta('crb_page_meta_description');
	$keywords = carbon_get_the_post_meta('crb_page_meta_keywords');
	$og_image = carbon_get_the_post_meta('crb_page_meta_og_image');
