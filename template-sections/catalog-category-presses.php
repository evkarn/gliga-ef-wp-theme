<?php
	$term_name = get_term_field('name', 7, 'equipment_type');
	$descr = carbon_get_term_meta( 7, 'crb_equipment_type_descr' );
	...
	$args = array(
		...
		'tax_query' => array(
			array(
				...
				'field' => 'slug',
				'terms' => 'pressy-svobodnoj-kovki-i-manipulyatory-hdmech'
			)
		)
	);
