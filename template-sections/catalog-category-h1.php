<?php
	...
	$descr = carbon_get_term_meta( $current_page_id, 'crb_equipment_type_descr' );
...
?>
<section class="section catalog-category catalog-category--universal">
	<div class="container catalog-category__container">
		<header class="section__header">
			<h1 class="h1 section__title title-decor catalog-category__title">
