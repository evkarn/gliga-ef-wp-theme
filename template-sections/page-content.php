<?php
	$image = carbon_get_the_post_meta( 'crb_page_content_image' );
	$title = carbon_get_the_post_meta( 'crb_page_content_title' );
	$descr = carbon_get_the_post_meta( 'crb_page_content_description' );
	$cards = carbon_get_the_post_meta( 'crb_page_content_cards' );
?>
